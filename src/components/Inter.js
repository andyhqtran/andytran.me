    ...
    <Global
      styles={css`
        ...
        @font-face {
          ...
          font-weight: 200;
          font-display: swap;
          src: url('/fonts/inter/Inter-ExtraLightItalic.woff2?v=3.13')
              format('woff2'),
            url('/fonts/inter/Inter-ExtraLightItalic.woff?v=3.13')
              format('woff');
        }
        ...
        @font-face {
          ...
          font-weight: 300;
          font-display: swap;
          src: url('/fonts/inter/Inter-LightItalic.woff2?v=3.13')
              format('woff2'),
        ...
        @font-face {
          ...
          font-weight: 500;
          font-display: swap;
          src: url('/fonts/inter/Inter-MediumItalic.woff2?v=3.13')
              format('woff2'),
        ...
        @font-face {
          ...
          font-weight: 600;
          font-display: swap;
          src: url('/fonts/inter/Inter-SemiBoldItalic.woff2?v=3.13')
              format('woff2'),
        ...
        @font-face {
          ...
          font-weight: 800;
          font-display: swap;
          src: url('/fonts/inter/Inter-ExtraBoldItalic.woff2?v=3.13')
              format('woff2'),
        ...
        @font-face {
          ...
          font-weight: 900;
          font-display: swap;
          src: url('/fonts/inter/Inter-BlackItalic.woff2?v=3.13')
              format('woff2'),
