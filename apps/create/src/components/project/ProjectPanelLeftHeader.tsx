...
export const ProjectPanelLeftHeader = ({ className, ...restOfProps }: ProjectPanelLeftTitleProps) => {
  ...
  return (
    <header
      ...
      {...restOfProps}
    >
      <h2 className='text-base font-semibold capitalize text-slate-12'>{projectPanelActiveValue}</h2>
    </header>
  );
};
