...
const ProjectPanelLeft = dynamic(
  () => import('~/components/project/ProjectPanelLeft').then((mod) => mod.ProjectPanelLeft),
  { ssr: false },
);

const ProjectPropertiesPanel = dynamic(
  () => import('~/components/project/ProjectPropertiesPanel').then((mod) => mod.ProjectPropertiesPanel),
  {
