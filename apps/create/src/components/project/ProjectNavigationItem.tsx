  ...
  return (
    <button
      className={classNames(
        "test flex h-10 w-10 items-center justify-center rounded border outline-none transition-colors focus-visible:ring-2 focus-visible:ring-blue-7 focus-visible:ring-offset-1",
        isActive
